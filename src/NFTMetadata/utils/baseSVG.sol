...
library baseSVG {
                ...
                string.concat(
                    ...
                    svg.prop(
                        ...
                        string.concat(
                            ...
                            _assetReader.readAsset(bytes4(keccak256("USDX")))
                        )
                    )
                )
            );
            ...
            svg.el(
                ...
                string.concat(
                    ...
                    svg.prop(
                        ...
                        string.concat(
                            "data:image/svg+xml;base64,",
                            _assetReader.readAsset(
                                bytes4(keccak256(bytes(_collName)))
                            )
                        )
                    )
                )
    ...
    function _dynamicTextEls(
        ...
        return
            string.concat(
                _formattedDynamicEl(
                    numUtils.toLocaleString(_coll, 18, 4),
                    256,
                    360
                ),
                _formattedDynamicEl(
                    numUtils.toLocaleString(_debt, 18, 2),
                    256,
                    391
                ),
                _formattedDynamicEl(
                    numUtils.toLocaleString(_annualInterestRate, 16, 2),
                    256,
                    422
                )
            );
